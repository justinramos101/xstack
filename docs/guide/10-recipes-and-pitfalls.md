...
This page lists prompts worth copying, then the mistakes everyone makes once. Swap in your own paths and finish conditions. The recipes are informal on purpose. That's how they get typed in practice, and the skills read intent fine.
...
Your current design becomes one candidate among several, and the synthesis tells you whether the panel found something better or confirmed what you had. It costs little next to reversing the decision later.
...
- **Parallel agents in one worktree.** They overwrite each other, and untangling the diff takes longer than the work did. Say "own worktree per attempt" and the isolation is free.
