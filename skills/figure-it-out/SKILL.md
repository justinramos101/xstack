...
Create a visible checklist whose first item is to read the Principles section of the **poteto-mode** skill and the leaf skills for principles you apply. Then add the phases below. Use an available task or planning tool, or a Markdown plan file per [Host runtime](../poteto-mode/references/host-runtime.md#plans-and-task-tracking).
...
Then execute the design. Add its steps to the checklist as concrete items, after the Phase C entry and before Phase D. Run each under the Phase C loop discipline, and weave the Phase D log through them, a row as each step lands, rather than saving the whole trail for the end.
